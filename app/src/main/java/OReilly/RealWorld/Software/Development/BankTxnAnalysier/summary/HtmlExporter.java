package OReilly.RealWorld.Software.Development.BankTxnAnalysier.summary;

public class HtmlExporter implements Exporter {
    @Override
    public ExporterResult export(SummaryStatistics summaryStatistics) {
        ...
        result += "</body>";
        result += "</html>";
        ExporterResult exporterResult = new ExporterResult();
        exporterResult.res = result;
